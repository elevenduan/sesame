<template>
  <WingBlank>
    ...
    <Button type="ghost" inline :style="{marginRight:'4px'}" class="am-button-borderfix">inline ghost</Button>
    ...
    <Button type="ghost" inline size="small" class="am-button-borderfix" disabled>ghost disabled</Button>
  </WingBlank>
</template>
<script>
import { Button, WhiteSpace, WingBlank, TouchFeedback } from '@/components/index'
